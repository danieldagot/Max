...
export default function Split() {
    ...
    const [carbs, setcarbs] = useState(human.castom_sptit_test.carbs ? human.castom_sptit_test.carbs : 10 )
    const [ptotin, setptotin] = useState(human.castom_sptit_test.ptotin ? human.castom_sptit_test.ptotin : 10 )
    const [fat, setfat] = useState(human.castom_sptit_test.fat ? human.castom_sptit_test.fat : 80 )
